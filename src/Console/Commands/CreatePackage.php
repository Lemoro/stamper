...
class CreatePackage extends Command
{
     ...
     * @var string
     */
    protected $signature = 'stamper:make {LoginAndPackageName?} {--l|light}';
...

    {
        ...
        $f = str_replace('Lemoro', $this->LoginGit, $f);
        $f = str_replace('lemoro', strtolower($this->LoginGit), $f);
        $f = str_replace('stamper', strtolower($this->packageName), $f);
        $f = str_replace('Stamper', $this->className, $f);
    ...
    private function getData()
    {
        ...
        $this->selfPath = base_path('vendor/lemoro/stamper/');
